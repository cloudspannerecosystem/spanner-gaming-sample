...
// Package config provides configuration for the tradepost service.
//
...
// Config contains all of the available configurations for the tradepost service
type Config struct {
	Server  ServerConfig
	Spanner SpannerConfig
}

// ServerConfig contains the information to expose the tradepost service as a server
